...
def login(request):
    ...
    if request.user.is_authenticated():
        return HttpResponseRedirect("http://dezelon.pythonanywhere.com")
...
def callback(request):
    ...
    logger.error("1 "+request.GET['state'])
